...
a8 = Album.create(cover: "https://en.wikipedia.org/wiki/File:Circa_2007.jpg", title: "Circa 2007", artist: "Circa")
Track.create(name: "Cut the Ties", minutes: 6, album_id: a8.id)
Track.create(name: "Don't Let Go", minutes: 7, album_id: a8.id)
Track.create(name: "Together We Are", minutes: 7, album_id: a8.id)
Track.create(name: "Information Overload", minutes: 6, album_id: a8.id)
Track.create(name: "Trust in Something", minutes: 8, album_id: a8.id)
Track.create(name: "Keeper of the Flame", minutes: 3, album_id: a8.id)
Track.create(name: "Life Going  by", minutes: 4, album_id: a8.id)
Track.create(name: "Look Inside", minutes: 5, album_id: a8.id)
Track.create(name: "Brotherhood of Man", minutes: 12, album_id: a8.id)
